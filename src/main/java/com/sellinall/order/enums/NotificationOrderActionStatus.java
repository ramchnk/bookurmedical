...
public enum NotificationOrderActionStatus {
	...
	ACCEPTED_TO_COMPLETED("ACCEPTED_TO_COMPLETED"), /* No Action */
	...
	COMPLETED_TO_DISPATCHED("COMPLETED_TO_DISPATCHED"), /* No Action */
	COMPLETED_TO_CANCELLED("COMPLETED_TO_CANCELLED"), /* No Action */
